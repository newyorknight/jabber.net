...
namespace Kixeye.Jabber.Client
{
    ...
    /// </summary>
    public class RosterManager : Kixeye.Jabber.Connection.StreamComponent, IEnumerable
    {
        ...
        {
            this.OnStreamChanged += new Kixeye.Bedrock.ObjectHandler(RosterManager_OnStreamChanged);
        }
        ...
        private void RosterManager_OnStreamChanged(object sender)
        {
            ...
            cli.OnDisconnect += new Kixeye.Bedrock.ObjectHandler(GotDisconnect);
        }
        ...
        /// </summary>
        public event Kixeye.Bedrock.ObjectHandler OnRosterBegin;

        /// <summary>
        /// Informs the client that the roster has been retrieved from the XMPP server.
        /// </summary>
        public event Kixeye.Bedrock.ObjectHandler OnRosterEnd;
        ...
        {
            if ((iq.Query == null) ||
                (iq.Query.NamespaceURI != Kixeye.Jabber.Protocol.URI.ROSTER) ||
