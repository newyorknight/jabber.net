...
namespace Kixeye.Jabber.Client
{
    ...
    /// </summary>
    public class PresenceManager : Kixeye.Jabber.Connection.StreamComponent, IEnumerable
    {
        ...
        {
            this.OnStreamChanged += new Kixeye.Bedrock.ObjectHandler(PresenceManager_OnStreamChanged);
        }
