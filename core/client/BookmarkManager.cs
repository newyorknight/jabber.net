...
namespace Kixeye.Jabber.Client
{
    ...
    /// </summary>
    public class BookmarkManager : Kixeye.Jabber.Connection.StreamComponent
	{
		...
		{
            this.OnStreamChanged += new Kixeye.Bedrock.ObjectHandler(BookmarkManager_OnStreamChanged);
		}
        ...
        private void BookmarkManager_OnStreamChanged(object sender)
        {
            ...
            if (cli != null)
                cli.OnAuthenticate += new Kixeye.Bedrock.ObjectHandler(cli_OnAuthenticate);
        }
