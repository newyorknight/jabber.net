...
namespace Kixeye.Jabber.Connection
{
    ...
    public class CapsManager: StreamComponent
    {
        ...
        public string FileName
        {
            ...
            set
            {
                if (m_cache == null)
                {
                    ...
                    ef.AddType(new Kixeye.Jabber.Protocol.IQ.Factory());
        ...
        private void CapsManager_OnStreamChanged(object sender)
        {
            ...
            Kixeye.Jabber.Client.JabberClient jc = m_stream as Kixeye.Jabber.Client.JabberClient;
            if (jc == null)
                return;

            jc.OnBeforePresenceOut += new Kixeye.Jabber.Client.PresenceHandler(jc_OnBeforePresenceOut);
            jc.OnIQ += new Kixeye.Jabber.Client.IQHandler(jc_OnIQ);
            jc.OnPresence += new Kixeye.Jabber.Client.PresenceHandler(jc_OnPresence);
        }
