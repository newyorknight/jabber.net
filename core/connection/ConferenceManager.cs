...
namespace Kixeye.Jabber.Connection
{
    ...
    public class ConferenceManager : StreamComponent
    {
        ...
        {
            this.OnStreamChanged += new Kixeye.Bedrock.ObjectHandler(ConferenceManager_OnStreamChanged);
        }
 ...
 */
    ...
    public class Room
    {
        ...
        internal Room(ConferenceManager manager, JID roomAndNick)
        {
            ...
            stream.OnProtocol += new Kixeye.Jabber.Protocol.ProtocolHandler(m_stream_OnProtocol);
            JabberClient jc = stream as JabberClient;
            if (jc != null)
                jc.OnAfterPresenceOut += new Kixeye.Jabber.Client.PresenceHandler(m_stream_OnAfterPresenceOut);
        }
 ...
 */
            ...
            m_manager.Stream.OnProtocol -= new Kixeye.Jabber.Protocol.ProtocolHandler(m_stream_OnProtocol);
            Kixeye.Jabber.Client.JabberClient jc = m_manager.Stream as Kixeye.Jabber.Client.JabberClient;
            if (jc != null)
                jc.OnAfterPresenceOut -= new Kixeye.Jabber.Client.PresenceHandler(m_stream_OnAfterPresenceOut);
