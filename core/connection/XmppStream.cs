...
namespace Kixeye.Jabber.Connection
{
    ...
    abstract public class XmppStream : IStanzaEventListener
    {
        ...
        /// </summary>
        public event Kixeye.Bedrock.ExceptionHandler OnError;
        ...
        /// </summary>
        public event Kixeye.Bedrock.ObjectHandler OnAuthenticate;
        ...
        /// </summary>
        public event Kixeye.Bedrock.ObjectHandler OnDisconnect;
        ...
        public void WriteStartTag(Kixeye.Jabber.Protocol.Stream.Stream elem)
        {
        ...
        protected virtual void OnDocumentStart(object sender, System.Xml.XmlElement elem)
        {
            ...
            if (elem is Kixeye.Jabber.Protocol.Stream.Stream)
            {
                Kixeye.Jabber.Protocol.Stream.Stream str = elem as Kixeye.Jabber.Protocol.Stream.Stream;
                ...
                if (m_serverVersion.StartsWith("1."))
                {
                    lock (m_stateLock)
                    {
                        if (State == SASLState.Instance)
                            ...
                            State = Kixeye.Jabber.Connection.ServerFeaturesState.Instance;
                    }
                }
                else
                {
        ...
        protected virtual void OnElement(object sender, System.Xml.XmlElement tag)
        {
            ...
            if (tag is Kixeye.Jabber.Protocol.Stream.Error)
            {
            ...
            else if (State == CompressionState.Instance)
            {
                ...
                case "failure":
                    ...
                    FireOnError(new Kixeye.Bedrock.IO.CompressionFailedException(fail.Error));
                    return;
                }
        ...
        {
            Kixeye.Jabber.Protocol.Stream.Stream str = new Kixeye.Jabber.Protocol.Stream.Stream(m_doc, NS);
