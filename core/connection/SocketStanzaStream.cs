    ...
    public class SocketStanzaStream : StanzaStream, ISocketEventListener
    {
        ...
        public override bool SupportsCompression
        {
            get
            {
                try
                {
                    return Kixeye.Bedrock.IO.ZlibStream.Supported;
                }
                catch
                {
        ...
        public override void InitializeStream()
        {
            ...
            m_elements.OnDocumentEnd += new Kixeye.Bedrock.ObjectHandler(m_elements_OnDocumentEnd);
            m_elements.OnElement += new ProtocolHandler(m_elements_OnElement);
            m_elements.OnError += new Kixeye.Bedrock.ExceptionHandler(m_elements_OnError);
        ...
        public override void WriteStartTag(Kixeye.Jabber.Protocol.Stream.Stream stream)
        {
