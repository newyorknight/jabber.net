...
namespace Kixeye.Jabber.Connection
{
    ...
    public class PubSubManager : StreamComponent
    {
        ...
        {
            this.OnStreamChanged += new Kixeye.Bedrock.ObjectHandler(PubSubManager_OnStreamChanged);
        }
        ...
        /// </param>
        public void RemoveNode(JID service, string node, Kixeye.Bedrock.ExceptionHandler errorHandler)
        {
            JIDNode jn = new JIDNode(service, node);
    ...
    public class PubSubNode : StreamComponent, IEnumerable
    {
        ...
        public void Create(Kixeye.Jabber.Protocol.X.Data config)
        {
            lock (this)
            {
