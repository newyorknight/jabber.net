...
namespace Kixeye.Jabber
{
    ...
    {
#if !NO_STRINGPREP
        private static readonly Kixeye.Bedrock.StringPrep.Profile s_nodeprep     = new Kixeye.Bedrock.StringPrep.XmppNode();
        private static readonly Kixeye.Bedrock.StringPrep.Profile s_nameprep     = new Kixeye.Bedrock.StringPrep.Nameprep();
        private static readonly Kixeye.Bedrock.StringPrep.Profile s_resourceprep = new Kixeye.Bedrock.StringPrep.XmppResource();
#endif
