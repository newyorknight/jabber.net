...
namespace Kixeye.Jabber.Protocol.Client
{
    ...
    public class Presence : Packet, IComparable<Presence>, IComparable
    {
        ...
        public DateTime Stamp
        {
            get
            {
                Kixeye.Jabber.Protocol.X.ModernDelay md = GetChildElement<Kixeye.Jabber.Protocol.X.ModernDelay>();
                if (md != null)
                    return md.Stamp;
                Kixeye.Jabber.Protocol.X.Delay delay = GetChildElement<Kixeye.Jabber.Protocol.X.Delay>();
                if (delay != null)
                    return delay.Stamp;
            ...
            set
            {
                ...
                md = new Kixeye.Jabber.Protocol.X.ModernDelay(this.OwnerDocument);
                md.Stamp = value;
                this.AddChild(md);
            }
        }
