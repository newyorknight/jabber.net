...
namespace Kixeye.Jabber.Protocol.Stream
{
    ...
    public class Compression : Element
    {
        ...
        public Compression(XmlDocument doc) :
            base("", new XmlQualifiedName("compression", Kixeye.Jabber.Protocol.URI.COMPRESS_FEATURE), doc)
        {
        }
    ...
    public class CompressionFailure : Element
    {
        ...
        public CompressionFailure(XmlDocument doc) :
            base("", new XmlQualifiedName("failure", Kixeye.Jabber.Protocol.URI.COMPRESS), doc)
        {
        }
    ...
    public class Compress : Element
    {
        ...
        public Compress(XmlDocument doc) :
            base("", new XmlQualifiedName("compress", Kixeye.Jabber.Protocol.URI.COMPRESS), doc)
        {
        }
    ...
    public class Compressed : Element
    {
        ...
        public Compressed(XmlDocument doc) :
            base("", new XmlQualifiedName("compressed", Kixeye.Jabber.Protocol.URI.COMPRESS), doc)
        {
        }
