...
namespace Kixeye.Jabber.Protocol.Stream
{
    ...
    public class Mechanisms : Element
    {
        ...
        public Mechanisms(XmlDocument doc) :
            base("", new XmlQualifiedName("mechanisms", Kixeye.Jabber.Protocol.URI.SASL), doc)
        {
        }
    ...
    public class Mechanism : Element
    {
        ...
        public Mechanism(XmlDocument doc) :
            base("", new XmlQualifiedName("mechanism", Kixeye.Jabber.Protocol.URI.SASL), doc)
        {
        }
    ...
    public class Auth : Step
    {
        ...
        public Auth(XmlDocument doc) :
            base("", new XmlQualifiedName("auth", Kixeye.Jabber.Protocol.URI.SASL), doc)
        {
        }
        ...
        public MechanismType Mechanism
        {
            get
            {
                ...
                return Kixeye.Jabber.Protocol.Stream.Mechanism.GetMechanismType(m);
            }
            set
            {
                string m = Kixeye.Jabber.Protocol.Stream.Mechanism.GetMechanism(value);
    ...
    public class Challenge : Step
    {
        ...
        public Challenge(XmlDocument doc) :
            base("", new XmlQualifiedName("challenge", Kixeye.Jabber.Protocol.URI.SASL), doc)
        {
        }
    ...
    public class Response : Step
    {
        ...
        public Response(XmlDocument doc) :
            base("", new XmlQualifiedName("response", Kixeye.Jabber.Protocol.URI.SASL), doc)
        {
        }
    ...
    public class SASLFailure : Step
    {
        ...
        public SASLFailure(XmlDocument doc) :
            base("", new XmlQualifiedName("failure", Kixeye.Jabber.Protocol.URI.SASL), doc)
        {
        }
    ...
    public class Abort : Step
    {
        ...
        public Abort(XmlDocument doc) :
            base("", new XmlQualifiedName("abort", Kixeye.Jabber.Protocol.URI.SASL), doc)
        {
        }
    ...
    public class Success : Step
    {
        ...
        public Success(XmlDocument doc) :
            base("", new XmlQualifiedName("success", Kixeye.Jabber.Protocol.URI.SASL), doc)
        {
        }
