...
namespace Kixeye.Jabber.Protocol.IQ
{
    ...
    public class OwnerPubSubCommandIQ<T> : Kixeye.Jabber.Protocol.Client.TypedIQ<OwnerPubSub<T>>
    ...
    public class OwnerConfigure : PubSubCommand
    {
        ...
        /// </summary>
        public Kixeye.Jabber.Protocol.X.Data MetaData
        {
            get { return GetChildElement<Kixeye.Jabber.Protocol.X.Data>(); }
            set { ReplaceChild<Kixeye.Jabber.Protocol.X.Data>(value); }
        }
    }
