...
#region base protocol
    ...
    /// </summary>
    public class RoomPresence : Kixeye.Jabber.Protocol.Client.Presence
    {
        /// <summary>
...
#region admin
    ...
    /// </summary>
    public class RoomAdminIQ : Kixeye.Jabber.Protocol.Client.TypedIQ<AdminQuery>
    {
        /// <summary>
...
#region owner
    ...
    /// </summary>
    public class OwnerIQ : Kixeye.Jabber.Protocol.Client.TypedIQ<OwnerQuery>
    {
        /// <summary>
        /// Create
        /// </summary>
    ...
    public class OwnerQuery : Element
    {
        ...
        /// </summary>
        public Kixeye.Jabber.Protocol.X.Data Form
        {
            get { return GetOrCreateElement("x", URI.XDATA, typeof(Kixeye.Jabber.Protocol.X.Data)) as Kixeye.Jabber.Protocol.X.Data; }
            set { ReplaceChild(value); }
        }
    ...
    /// </summary>
    public class UniqueIQ : Kixeye.Jabber.Protocol.Client.IQ
    {
        /// <summary>
        /// Create
        /// </summary>
